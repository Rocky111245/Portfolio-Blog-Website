...
import styles from './CoreFocusSection.module.css';

const CoreFocusSection = () => {
    return (
        <div className={styles.coreFocusSection}>
            <h2 className={styles.title}>Expertise Highlights</h2>
            <div className={styles.cardsContainer}>
                <div className={styles.card}>
                    <img src={'https://ik.imagekit.io/emtbd/BLOG/Matrix%20multiplication.png?updatedAt=1718281932848'} alt="Mathematics and Software" className={styles.cardImage} />
                ...
                <div className={styles.card}>
                    <img src={'https://ik.imagekit.io/emtbd/BLOG/Neural_network.svg.png?updatedAt=1718281931774'} alt="Fundamentals of Machine Learning" className={styles.cardImage} />
                ...
                <div className={styles.card}>
                    <img src={'https://ik.imagekit.io/emtbd/BLOG/DSA.png?updatedAt=1718281918942'} alt="Data Structures and Algorithms" className={styles.cardImage} />
