    ...
    <div className={styles.aboutMeContainer}>
      ...
      <section className={styles.introSection}>
        <p className={styles.introParagraph}>
          Blending the innovative spirit of a Renewable Energy Engineer with the technical prowess of a Software Developer, I bring a unique perspective to complex problem-solving, leveraging over two years of diverse technological expertise.
        </p>
      </section>
      ...
      <section className={styles.backgroundSection}>
        ...
        <p className={styles.paragraph}>
          My path has been one of continuous learning and exploration. From delving into sustainable energy solutions to crafting software, I've always been driven by curiosity and the desire to make a positive impact.
        </p>
        <div className={styles.journeyPath}>
          {['Renewable Energy Engineering', 'Self-taught Web Development', 'Embedded and Electronic Systems', 'Mathematics for Neural Networks', 'Machine Learning and AI'].map((step, index, array) => (
            <div key={index} className={styles.journeyStep}>
              <span className={styles.journeyStepText}>{step}</span>
              {index < array.length - 1 && <span className={styles.arrow}>→</span>}
            </div>
          ))}
        </div>
        <p className={styles.paragraph}>
          I keep on exploring, as proven by my many projects. This drive has led me to explore various areas of software development, including building neural network framework and diving deep into algorithms and embedded systems.
        </p>
      </section>

      <section className={styles.recruiterAppealSection}>
        <h2 className={styles.sectionTitle}>What Sets Me Apart</h2>
        <ul className={styles.appealList}>
          {[
            ...
            "Global perspective gained from participation in multiple international conferences and exhibitions.",
            ...
            <li key={index} className={styles.appealItem}>{item}</li>
          ))}
        </ul>
      </section>

      <section className={styles.globalPerspectiveSection}>
        <h2 className={styles.sectionTitle}>Global Perspective</h2>
        <p className={styles.paragraph}>
